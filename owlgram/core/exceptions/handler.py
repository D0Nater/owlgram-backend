...
class ErrorSchema(BaseModel):
    ...
    detail: str | None = Field(
        ...
        examples=["User 1 not found."],
    )
    error_code: str = Field(description="Exception name.", examples=["UserNotFoundException"])
    ...
    additional_info: dict[str, Any] = Field(
        description="Additional computer-readable information.", examples=[{"user_id": 1}]
    )
